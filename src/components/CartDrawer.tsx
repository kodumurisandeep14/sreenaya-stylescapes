          ...
          {items.length === 0 ? (
            <div className="flex-1 flex items-center justify-center">
              <div className="text-center">
                ...
                <p className="text-muted-foreground">No pieces added yet</p>
              </div>
            </div>
          ) : (
            <>
              ...
              <div className="space-y-4 pt-4 border-t bg-background">
                ...
                <Button onClick={handleCheckout} className="w-full bg-primary hover:bg-primary/90" size="lg" disabled={isLoading || isSyncing}>
